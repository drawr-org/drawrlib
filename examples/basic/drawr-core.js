...
/***/ function(module, exports, __webpack_require__) {
	...
	var DrawingCanvas = __webpack_require__(2);
...
/***/ function(module, exports) {
	...
	function mousedownListener(e) {
	    var mouseX = (e.changedTouches ? e.changedTouches[0].pageX : e.pageX) - this.canvas.offsetLeft;
	    var mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - this.canvas.offsetTop;
	    this.paint = true;
	    this.addClick(e.pageX - this.canvas.offsetLeft, e.pageY - this.canvas.offsetTop, '#1a7fcc');
	    this.redraw();
	}
	...
	function setEventListeners() {
	    this.canvas.addEventListener('mousedown', mousedownListener.bind(this), false);
	    this.canvas.addEventListener('mouseup', mouseupListener.bind(this), false);
	    this.canvas.addEventListener('mousemove', mousemoveListener.bind(this), false);
	    this.canvas.addEventListener('touchstart', mousedownListener.bind(this), false);
	    this.canvas.addEventListener('touchmove', mousemoveListener.bind(this), false);
	    this.canvas.addEventListener('touchend', mouseupListener.bind(this), false);
	}

	var DrawingCanvas = function DrawingCanvas(divId) {
	...
	DrawingCanvas.prototype.addClick = function (x, y, color) {
	    var dragging = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
